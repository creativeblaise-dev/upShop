...
useEffect(() => {
    ...
    return(
        <div>
         ...
         <h1 className="text-center font-bold text-3xl text-stone-900 mt-8 mb-4 italic">{category.toUpperCase()}</h1>
         <main className=" p-4 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 ">
